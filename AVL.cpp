...
bool AVL::balanceTree(Node* point)
{
    if (point->leftChild != NULL || point->rightChild != NULL)
    {
        ...
        if (point->leftChild == NULL)
        {
            if (point == root && point->rightChild->getHeight() > 1)
            {
                cout << "working" << endl;
                Node* p;
                p = point->rightChild;
            ...
            else if (point->rightChild->getHeight() > 1)
            {
                Node* p;
                p = point->rightChild;
                point->rightChild = p->leftChild;
            ...
            {
                cout << "balanced" << endl;
                return balanceTree(point->rightChild);
            }
        }

        else if (point->rightChild == NULL)
        {
            if (point->leftChild->getHeight() > 1)
            {
        ...
        {
            if (abs(point->leftChild->getHeight() - point->rightChild->getHeight()) > 1)
            {
                if (point->leftChild->getHeight() > point->rightChild->getHeight())
                {
                    cout << "run left" << endl;
                    balanceTree(point->leftChild);
                    return true;
                }
                else if (point->leftChild->getHeight() < point->rightChild->getHeight())
                {
                    cout << "run right" << endl;
                    balanceTree(point->rightChild);
                    if (abs(point->leftChild->getHeight() - point->rightChild->getHeight()) > 1)
                    {
                        Node* p;
                        p = point->rightChild;
